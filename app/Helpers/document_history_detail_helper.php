...
class DocumentHistoryDetail implements IJQGridDataSource {
	var $error = null;
	var $TABLE_NAME='document_history_detail';
	/**
	 * Constructor 
	 */
	...
	public function Update($id, $REQUEST) {
		$this->error=null;
        $item = ocrutil::Updatedocument_history_detailObject($REQUEST);
		return true;
	}
	...
	public function Delete($id) {
        return ocrutil::Deletedocument_history_detailObject($id);
	}
	
	public function Insert($REQUEST) {
		$this->error=null;
        return ocrutil::CreateUpdatedocument_history_detailObject($REQUEST);
		$id=DB::identityId();
		return $id;
	}

    public function SelectById($id) {
        return ocrutil::Retrievedocument_history_detailObject($id);
    }
