...
class ArchiveHistory implements IJQGridDataSource {
	var $error = null;
	var $TABLE_NAME='archive_history';
	/**
	 * Constructor 
	 */
	...
	public function Update($id, $REQUEST) {
		$this->error=null;
        $item = ocrutil::Updatearchive_historyObject($REQUEST);
		return true;
	}
	...
	public function Delete($id) {
        return ocrutil::Deletearchive_historyObject($id);
	}
	
	public function Insert($REQUEST) {
		$this->error=null;
        return ocrutil::CreateUpdatearchive_historyObject($REQUEST);
		$id=DB::identityId();
		return $id;
	}

    public function SelectById($id) {
        return ocrutil::Retrievearchive_historyObject($id);
    }
