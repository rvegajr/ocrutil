...
class ExceptionQueue implements IJQGridDataSource {
	var $error = null;
	var $TABLE_NAME='exception_queue';
	/**
	 * Constructor 
	 */
	...
	public function Update($id, $REQUEST) {
		$this->error=null;
        $item = ocrutil::Updateexception_queueObject($REQUEST);
		return true;
	}
	...
	public function Delete($id) {
        return ocrutil::Deleteexception_queueObject($id);
	}
	
	public function Insert($REQUEST) {
		$this->error=null;
        return ocrutil::CreateUpdateexception_queueObject($REQUEST);
		$id=DB::identityId();
		return $id;
	}

    public function SelectById($id) {
        return ocrutil::Retrieveexception_queueObject($id);
    }
